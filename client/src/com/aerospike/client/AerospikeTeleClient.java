...
public class AerospikeTeleClient implements IAerospikeClient {

	private final IAerospikeClient client;

	public AerospikeTeleClient(IAerospikeClient client) {
		this.client = client;
	}
	...
	public static void testtest(AerospikeTeleClient tc) {
		Record r = test(tc);
		System.out.println(r);
	}
